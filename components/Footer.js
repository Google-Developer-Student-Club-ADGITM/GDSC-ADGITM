          ...
          <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
            <div className="lg:w-1/2 md:w-1/2 w-full  " style={textColor}>
              ...
              <nav className="list-none mb-10">
                ...
                <a href='' className=" hover:text-gray-400 flex items-end md:justify-items-start justify-center">
                    ...
                    <span className='mx-2'> Visit Us </span></a>
                </li>

                <li className='mt-3 mb-3 text-center' >
                  <a href='' className="text-center hover:text-gray-400 flex items-end md:justify-items-start justify-center">
                ...
                <li className='mt-3 mb-3'>
                  <a href='' className="text-center hover:text-gray-400 flex items-center md:justify-center justify-center">
